...
const TweetBox = () => {
    ...
    const userProfilePic = loggedInUser[0]?.profileImage ? loggedInUser[0]?.profileImage : "https://api.imgbb.com/1/upload?key=b57255c97dfba596c705af1e6109287e"
    ...
    const handleUploadImage = (e) => {
        ...
        axios.post("https://api.imgbb.com/1/upload?key=b57255c97dfba596c705af1e6109287e", formData)
            .then(res => {
